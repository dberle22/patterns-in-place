...
- **Purpose**: Gold-layer industry structure mart that combines ACS industry employment mix, curated QCEW industry employment and wage levels, and BEA industry GDP structure in one geography-year table.
- **Row count**: `54,631`
...
3. `foundations/etl/silver/bls_qcew_silver.R` materializes the curated QCEW long table joined here.
4. `foundations/etl/silver/bea_cagdp9_silver.R` materializes BEA regional GDP metrics joined here.
5. `foundations/etl/gold/gold_economy_industry.sql` builds `gold.economics_industry_wide`.
