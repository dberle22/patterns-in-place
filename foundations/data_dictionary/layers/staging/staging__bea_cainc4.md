# Data Dictionary: staging BEA CAINC4 Family
...
| --- | --- | --- |
| CBSA | `bea_regional_cbsa_cainc4` | Regional personal income detail by metropolitan area |
| County | `bea_regional_county_cainc4` | Regional personal income detail by county |
| State | `bea_regional_state_cainc4` | Regional personal income detail by state |
