# Data Dictionary: staging BEA MARPP Family
...
| --- | --- | --- |
| CBSA | `bea_regional_cbsa_marpp` | Regional price parity by metropolitan area |
| State | `bea_regional_state_marpp` | Regional price parity by state |
