# Data Dictionary: staging BEA CAGDP9 Family
...
| --- | --- | --- |
| CBSA | `bea_regional_cbsa_cagdp9` | Regional GDP industry detail by metropolitan area |
| County | `bea_regional_county_cagdp9` | Regional GDP industry detail by county |
| State | `bea_regional_state_cagdp9` | Regional GDP industry detail by state |
