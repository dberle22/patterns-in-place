...
county_typology as (
    select
        ...
        industry_dependence_code as ers_industry_dependence_code,
        industry_dependence_label as ers_industry_dependence_label,
        persistent_poverty_flag as ers_persistent_poverty_flag,
        retirement_destination_flag as ers_retirement_destination_flag,
        population_loss_flag as ers_population_loss_flag,
        housing_stress_flag as ers_housing_stress_flag,
        low_employment_flag as ers_low_employment_flag,
        low_postsecondary_ed_flag as ers_low_postsecondary_ed_flag,
        high_farming_flag as ers_high_farming_flag,
        high_mining_flag as ers_high_mining_flag,
        high_manufacturing_flag as ers_high_manufacturing_flag,
        high_government_flag as ers_high_government_flag,
        high_recreation_flag as ers_high_recreation_flag,
        nonspecialized_flag as ers_nonspecialized_flag
    from patterns_in_place.silver.usda_county_typology
    where geo_level = 'county'
      and in_current_county_backbone = true
),
county_base as (
    select
        cs.county_geoid,
...
county_enriched as (
    select
        ...
        c.county_flag,
        ct.rucc_2023_code,
        ct.rucc_2023_description,
        ct.ers_industry_dependence_code,
        ct.ers_industry_dependence_label,
        ct.ers_persistent_poverty_flag,
        ct.ers_retirement_destination_flag,
        ct.ers_population_loss_flag,
        ct.ers_housing_stress_flag,
        ct.ers_low_employment_flag,
        ct.ers_low_postsecondary_ed_flag,
        ct.ers_high_farming_flag,
        ct.ers_high_mining_flag,
        ct.ers_high_manufacturing_flag,
        ct.ers_high_government_flag,
        ct.ers_high_recreation_flag,
        ct.ers_nonspecialized_flag,
        c.vintage,
        c.source
    from county_base c
    left join state_base sb
        on c.state_fips = sb.state_fips
    left join county_typology ct
        on c.county_geoid = ct.county_geoid
),
tract_base as (
    select
        tract_geoid,
...
us_row as (
    select
        ...
        cast(null as integer) as rucc_2023_code,
        cast(null as varchar) as rucc_2023_description,
        cast(null as integer) as ers_industry_dependence_code,
        cast(null as varchar) as ers_industry_dependence_label,
        cast(null as integer) as ers_persistent_poverty_flag,
        cast(null as integer) as ers_retirement_destination_flag,
        cast(null as integer) as ers_population_loss_flag,
        cast(null as integer) as ers_housing_stress_flag,
        cast(null as integer) as ers_low_employment_flag,
        cast(null as integer) as ers_low_postsecondary_ed_flag,
        cast(null as integer) as ers_high_farming_flag,
        cast(null as integer) as ers_high_mining_flag,
        cast(null as integer) as ers_high_manufacturing_flag,
        cast(null as integer) as ers_high_government_flag,
        cast(null as integer) as ers_high_recreation_flag,
        cast(null as integer) as ers_nonspecialized_flag,
        2023 as vintage,
...
county_rows as (
    select
        ...
        cast(null as integer) as county_count,
        ce.rucc_2023_code,
        ce.rucc_2023_description,
        ce.ers_industry_dependence_code,
        ce.ers_industry_dependence_label,
        ce.ers_persistent_poverty_flag,
        ce.ers_retirement_destination_flag,
        ce.ers_population_loss_flag,
        ce.ers_housing_stress_flag,
        ce.ers_low_employment_flag,
        ce.ers_low_postsecondary_ed_flag,
        ce.ers_high_farming_flag,
        ce.ers_high_mining_flag,
        ce.ers_high_manufacturing_flag,
        ce.ers_high_government_flag,
        ce.ers_high_recreation_flag,
        ce.ers_nonspecialized_flag,
        ce.vintage,
        ce.source
