-- Top 20 loosest major metros by 2024 housing vacancy rate.
...
ranked as (
  select
    'metro_rankings_loosest'::varchar as question_id,
    geo_level,
    geo_id,
    geo_name,
    ...
    row_number() over (order by vacancy_rate_pct desc, pop_total desc, geo_name) as rank,
    'Top 20 major metros by looseness (population >= 250k)'::varchar as "group",
