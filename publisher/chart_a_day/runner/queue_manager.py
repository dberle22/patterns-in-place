"""Queue helpers for the Chart-A-Day backlog."""
...
DEFAULT_QUEUE_PATH = Path(__file__).resolve().parents[1] / "backlog.yaml"


@dataclass
class QueueEntry:
    """Structured view of one Chart-A-Day queue row."""
    ...
    status: str
    platform: str
    produce_alternatives: bool = False
    notes: str | None = None
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "produce_alternatives": self.produce_alternatives,
            "notes": self.notes,
...
class QueueManager:
    """Load, inspect, and update the Chart-A-Day backlog in place."""
