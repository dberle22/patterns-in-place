...
output_dir <- file.path(repo_root, "publisher", "chart_a_day", "output", "q010")
...
box_plot <- render_boxplot(
  ...
  config = list(
    ...
    title = "How is median age distributed across US metros in 2023?",
    subtitle = "CBSAs with population >= 250k | 2023 snapshot",
    group_label = NULL,
    value_label = "Median age (years)",
    label_style = "number",
    label_accuracy = 0.1,
